...
setw -g window-status-format "#[fg=#1a1b26,bg=#1a1b26,nobold,noitalics,nounderscore]#[fg=#c0caf5,bg=#1a1b26] #I  #{window_name} #[fg=#1a1b26,bg=#1a1b26,nobold,noitalics,nounderscore]"
setw -g window-status-current-format "#[fg=#1a1b26,bg=#bb9af7,nobold,noitalics,nounderscore]#[fg=#1a1b26,bg=#bb9af7,bold] #I  #{window_name} #[fg=#bb9af7,bg=#1a1b26,nobold,noitalics,nounderscore]"
